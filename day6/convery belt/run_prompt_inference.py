...
def main():
    # Configuration	yoloe-26x-seg-pf.pt
    model_path = os.path.join(os.path.dirname(__file__), "yoloe-26n-seg.pt")
    input_video = os.path.join(os.path.dirname(__file__), "a.mp4")
    output_video = os.path.join(os.path.dirname(__file__), "output_harness_detection.mp4")
    
    prompt = ["class 1.coal Stones 2.convery belt"] # User requested prompt
